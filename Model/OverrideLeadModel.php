...
class OverrideLeadModel extends LeadModel
{
  ...
  public function getEntity($id = null)
  {
    ...
    $repo = new OverrideLeadRepository($this->em, $metastart);
  ...
  public function doSaveEntity($entity, $unlock = true)
  {
    ...
    //set some defaults
    FormModel::setTimestamps($entity, $isNew, $unlock);

    $event = FormModel::dispatchEvent('pre_save', $entity, $isNew);
    $this->getRepository()->saveExtendedEntity($entity);
    FormModel::dispatchEvent('post_save', $entity, $isNew, $event);
  }
